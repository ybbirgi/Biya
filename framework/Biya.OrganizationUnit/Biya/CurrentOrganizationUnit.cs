...
public class CurrentOrganizationUnit : ICurrentOrganizationUnit, ITransientDependency
{
    ...
    public CurrentOrganizationUnit(ICurrentOrganizationUnitAccessor currentOrganizationUnitAccessor)
    {
    ...
    private IDisposable SetCurrent(Guid? tenantId, string? name = null)
    {
        ...
        return new DisposeAction<ValueTuple<ICurrentOrganizationUnitAccessor, BasicOrganizationUnitInfo?>>(static (state) =>
        {
