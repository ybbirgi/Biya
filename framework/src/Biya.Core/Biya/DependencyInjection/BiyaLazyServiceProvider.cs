...
public class BiyaLazyServiceProvider : CachedServiceProviderBase, IBiyaLazyServiceProvider, ITransientDependency
{
    public BiyaLazyServiceProvider(
    ...
    public virtual object? LazyGetService(
        Type serviceType
    )
    {
